...
/**
 * A notification request used to chunk BLE notifications to a BLE GATT
 * Characteristic.
 *
 ...
 */
class NotifyRequest constructor (
	private val mtu: Int,
...
): Iterator<ByteArray>
{
	...
	/**
	 * The number of times this [NotifyRequest] has been attempted to be
	 * resent.
	 */
